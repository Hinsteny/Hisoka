...
public class DubboServiceExceptionFilter implements Filter {
    ...
    private Result handleException(BusinessException bex){
        String code = bex.getCode();
        String message = bex.getDescription();
        Map<String, Object> resultMap = bex.getResultMap();
        Result result = getRpcResult(code, message, resultMap, bex);
        return result;
    }

    private Result handleException(SystemException bex){
        String code = bex.getCode();
        String message = bex.getDescription();
        Map<String, Object> resultMap = bex.getResultMap();
        Result result = getRpcResult(code, message, resultMap, bex);
    ...
    private Map<String, Object> getResultMap(String attach) {
