 ...
 */
public class DuZookeeperRegistry extends ZookeeperRegistry {

    private final static Logger logger = LoggerFactory.getLogger(DuZookeeperRegistry.class);
    ...
    public DuZookeeperRegistry(URL url, ZookeeperTransporter zookeeperTransporter) {
            ...
            if (Constants.ANY_VALUE.equals(url.getServiceInterface())) {
                ...
                for (String path : toCategoriesPath(url)) {
                    ...
                    if (zkListener == null) {
                        listeners.putIfAbsent(listener, new ChildListener() {
                            public void childChanged(String parentPath, List<String> currentChilds) {
                                DuZookeeperRegistry.this.notify(url, listener, toUrlsWithEmpty(url, parentPath, currentChilds));
                            }
                        });
